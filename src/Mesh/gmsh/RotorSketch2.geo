...
//Bottom part
Point(3) = {0, 0.476969, 0.15, h};
Point(4) = {1, 0.476969, 0.15, h};
Point(5) = {0, 0.476969, -0.15, h};
Point(6) = {1, 0.476969, -0.15, h};

//Top part
Point(7) = {1,2.5,0.15,h};
Point(8) = {1,2.5,-0.15,h};
Point(9) = {0,2.5,0.15,h};
Point(10) = {0,2.5,-0.15,h};
